...
class Vocab(object):
  ...
  def __init__(self, vocab_file, max_size, encoding='UTF-8'):
    ...
    with open(vocab_file, 'r', encoding=self._encoding) as vocab_f:
      for line in vocab_f:
        pieces = line.split()
        if len(pieces) != 2:
  ...
  def write_metadata(self, fpath):
    ...
    with open(fpath, "w", encoding=self._encoding) as f:
      fieldnames = ['word']
